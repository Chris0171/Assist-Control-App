  ...
  <div class="container-fluid font-monospace">
    ...
    <div class="row justify-content-center align-items-center g-0">
      <div class="col-10 col-md-4 text-center p-3">
        <div></div>
        <select id="selectModules" class="form-select form-select-lg text-center" name="idModule">
          <option selected>Selecciona el Módulo</option>
        </select>
        <select id="selectGroups" class="form-select form-select-lg text-center" name="idGrupo">
